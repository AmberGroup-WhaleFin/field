...
// OrdCategoryField is a enum.OrdCategory field.
type OrdCategoryField struct{ quickfix.FIXString }

// Tag returns tag.OrdCategory (9000).
func (f OrdCategoryField) Tag() quickfix.Tag { return tag.OrdCategory }

func NewOrdCategory(val enum.OrdCategory) OrdCategoryField {
	return OrdCategoryField{quickfix.FIXString(val)}
}

func (f OrdCategoryField) Value() enum.OrdCategory { return enum.OrdCategory(f.String()) }
